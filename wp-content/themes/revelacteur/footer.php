...
?>
...
</main><footer class="site-footer-wrapper">
    ...
    <section class="footer-adventure-section">
        <div class="container">
            ...
            <h2 class="adventure-title"><?php echo esc_html($adv_title); ?></h2>
            <p class="adventure-text"><?php echo nl2br(esc_html($adv_text)); ?></p>
        ...
        <div class="container flex-container">
            ...
            <div class="contact-right">
                ...
                <ul class="social-icons purple-icons">
                    <?php if ( $instagram_url ) : ?><li><a href="<?php echo esc_url( $instagram_url ); ?>" target="_blank"><span class="dashicons dashicons-instagram"></span></a></li><?php endif; ?>
                    <?php if ( $linkedin_url ) : ?><li><a href="<?php echo esc_url( $linkedin_url ); ?>" target="_blank"><span class="dashicons dashicons-linkedin"></span></a></li><?php endif; ?>
                    <?php if ( $youtube_url ) : ?><li><a href="<?php echo esc_url( $youtube_url ); ?>" target="_blank"><span class="dashicons dashicons-youtube"></span></a></li><?php endif; ?>
                    <?php if ( $facebook_url ) : ?><li><a href="<?php echo esc_url( $facebook_url ); ?>" target="_blank"><span class="dashicons dashicons-facebook"></span></a></li><?php endif; ?>
                    <?php if ( $twitch_url ) : ?><li><a href="<?php echo esc_url( $twitch_url ); ?>" target="_blank"><span class="dashicons dashicons-twitch"></span></a></li><?php endif; ?>
                    <?php if ( isset($spotify_url) && $spotify_url ) : ?><li><a href="<?php echo esc_url( $spotify_url ); ?>" target="_blank"><span class="dashicons dashicons-format-audio"></span></a></li><?php endif; ?>
                </ul>
            </div>
        </div>
    </section>
