...
<div id="primary" class="content-area" >
    <main id="main" class="site-main">
        ...
        <div class="container" ">
            ...
            <h1 class="page-title" style="margin: 0;  margin-left: 10vw;   text-align: left;    font-family: 'RedsAglonema', cursive;  color: var(--color-secondary); font-size: 6rem;z-index: 10; /* Important : Assure que le texte passe AU-DESSUS de l'image */position: relative; ">Mécénat & Partenariat</h1>
